...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="https://www.hostinger.com.br/cpanel-login"><i aria-hidden="true" class="fa fa-lock"></i> Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="empty-account-page">
        ...
        <div class="row message">
            <p>O Website <span id="website" style="word-break:break-all;"></span> Foi instalado com sucesso no servidor! Por favor apague o arquivo <span style="font-weight: bold;">default.php</span> da pasta public_html e então envie seu website utilizando FTP ou o Gerenciador de Arquivos.</p>
        </div>
        <div class="col-xs-12">
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://www.hostinger.com.br/hospedagem-de-sites">Hospedagem de Sites</a> |
